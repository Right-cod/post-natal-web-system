...
<?php include('navbar.php'); ?>
    <div class="main_content">
        ...
        <h1 class="text-center">React to Questions</h1>
        <!--edit start-->
...
function disp_data()
{
    ...
    xmlhttp.open("GET","question.php?status=disp",false);
    xmlhttp.send(null);
...
function update_value(id,reply){
    var xmlhttp=new XMLHttpRequest();
    xmlhttp.open("GET","question.php?id="+id+"&reply="+reply+"&status=update",false);
    xmlhttp.send(null); 
}
</script> 
<!--alter  end-->
...
function delete1(id){
  var xmlhttp=new XMLHttpRequest();
    xmlhttp.open("GET","question.php.php?id="+id+"&status=delete",false);
    xmlhttp.send(null); 
    disp_data();
}
</script>
