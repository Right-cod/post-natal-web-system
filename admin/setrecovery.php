    ...
    <div class="main_content">
      ...
      <a href="admin-profile.php">Go back</a>
        ...
        <div class="wait overlay1">
          ...
          <fieldset>
            <legend>Set or Update recovery question</legend>
            <div class="container-fluid">
            <div class="panel-footer" id="e_msg"></div> 
            <div class="panel-footer" id="signup_msg"></div>
          	<form id="set_recovery_form" onsubmit="return false" >
                <div class="field">
        ...
        <div class="field">
                  <select name="question1" required  class="form-control">
                      ...
                      <option value="village">Which village was your mum born?</option>
                      <option value="pet">What is the name of your primary school?</option>
                      <option value="pet">Which is your favorite game?</option>
                  </select>
                </div>
                <div class="field">
                  <input type="text" name="answer1" id="" required  class="form-control"> 
                ...
                <div class="field">
                  <input type="text" name="answer2" id="" required  class="form-control"> 
...
<script>
  ...
  //set recovery
$("#set_recovery_form").on("submit",function(event){
	event.preventDefault();
	$(".overlay1").show();
	$.ajax({
		url	:	"admin_login.php",
		method:	"POST",
		data	:$("#set_recovery_form").serialize(),
